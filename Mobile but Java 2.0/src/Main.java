/* Remember the Mobile problem from SICP (problem 2.29)? Here's a solution in Scheme: https://paleyontology.com/AP_CS/mobile_soln.html
    We will now recreate this in Java! In this version, we'll design the program with Structure as an class. Here are a few key facts:
